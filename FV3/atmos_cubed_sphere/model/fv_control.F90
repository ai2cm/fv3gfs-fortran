...
!--------------------------------------------------
         ...
         if (grids_on_this_pe(n)) then
            ...
            !$ser data edge_s=Atm(n)%gridstruct%edge_s edge_n=Atm(n)%gridstruct%edge_n edge_w=Atm(n)%gridstruct%edge_w edge_e=Atm(n)%gridstruct%edge_e edge_vect_s=Atm(n)%gridstruct%edge_vect_s edge_vect_n=Atm(n)%gridstruct%edge_vect_n edge_vect_w=Atm(n)%gridstruct%edge_vect_w edge_vect_e=Atm(n)%gridstruct%edge_vect_e del6_u=Atm(n)%gridstruct%del6_u del6_v=Atm(n)%gridstruct%del6_v divg_u=Atm(n)%gridstruct%divg_u divg_v=Atm(n)%gridstruct%divg_v cosa_u=Atm(n)%gridstruct%cosa_u cosa_v=Atm(n)%gridstruct%cosa_v cosa_s=Atm(n)%gridstruct%cosa_s sina_u=Atm(n)%gridstruct%sina_u sina_v=Atm(n)%gridstruct%sina_v rsin_u=Atm(n)%gridstruct%rsin_u rsin_v=Atm(n)%gridstruct%rsin_v rsina=Atm(n)%gridstruct%rsina rsin2=Atm(n)%gridstruct%rsin2 cosa=Atm(n)%gridstruct%cosa sina=Atm(n)%gridstruct%sina sin_sg=Atm(n)%gridstruct%sin_sg cos_sg=Atm(n)%gridstruct%cos_sg ks=Atm(n)%ks ptop=Atm(n)%ptop ak=Atm(n)%ak bk=Atm(n)%bk z11=Atm(n)%gridstruct%z11 z12=Atm(n)%gridstruct%z12 z21=Atm(n)%gridstruct%z21 z22=Atm(n)%gridstruct%z22 a11=Atm(n)%gridstruct%a11 a12=Atm(n)%gridstruct%a12 a21=Atm(n)%gridstruct%a21 a22=Atm(n)%gridstruct%a22 da_min=Atm(n)%gridstruct%da_min da_max=Atm(n)%gridstruct%da_max da_min_c=Atm(n)%gridstruct%da_min_c da_max_c=Atm(n)%gridstruct%da_max_c ec1=Atm(n)%gridstruct%ec1 ec2=Atm(n)%gridstruct%ec2 ew1=Atm(n)%gridstruct%ew(:, :, :, 1) ew2=Atm(n)%gridstruct%ew(:, :, :, 2) es1=Atm(n)%gridstruct%es(:, :, :, 1) es2=Atm(n)%gridstruct%es(:, :, :, 2) l2c_v=Atm(n)%gridstruct%l2c_v l2c_u=Atm(n)%gridstruct%l2c_u ee1=Atm(n)%gridstruct%ee1 ee2=Atm(n)%gridstruct%ee2
