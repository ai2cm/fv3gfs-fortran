...
subroutine fv_sat_adj (mdt, zvir, is, ie, js, je, ng, hydrostatic, consv_te, te0,&
    ...
    do j = js, je ! start j loop
        ...
        ! -----------------------------------------------------------------------
        !_$ser verbatim if (j == js) then
        !_$ser savepoint WQS2-In
        !_$ser data table=table table2=table2 tablew=tablew des2=des2 desw=desw wqsat=wqsat dq2dt=dq2dt 
        !_$ser verbatim endif
        call wqs2_vect (is, ie, pt1, den, wqsat, dq2dt)
        !_$ser verbatim if (j == js) then
        !_$ser savepoint WQS2-Out
        !_$ser data wqsat=wqsat dq2dt=dq2dt
        !_$ser verbatim endif
        adj_fac = sat_adj0
        do i = is, ie
